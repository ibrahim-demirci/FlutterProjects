...
import 'package:note_app_sqflite_flutter/kategori_islemleri.dart';
import 'package:note_app_sqflite_flutter/not_detay.dart';
import 'package:note_app_sqflite_flutter/responsive/size_config.dart';
import 'package:note_app_sqflite_flutter/utils/database_helper.dart';
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ButtonBar(
                            children: [
                              FlatButton(onPressed: () => _notSil(tumNotlar[index].notID), child: Text("SİL")),
                              FlatButton(
                                  onPressed: () {
