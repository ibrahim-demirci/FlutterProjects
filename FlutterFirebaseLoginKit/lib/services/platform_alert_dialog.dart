...
import 'package:flutterx_firebaselogin/constants/keys.dart';
...
class PlatformExceptionAlertDialog extends PlatformAlertDialog {
  ...
  static Map<String, String> errors = {
    ...
    'ERROR_USER_NOT_FOUND': 'The email address is not registered. Register for a new account',
    ...
    'Invalid format': 'Invalid Formatting. Use [+][country code][subscriber number including area code].'
  };
}