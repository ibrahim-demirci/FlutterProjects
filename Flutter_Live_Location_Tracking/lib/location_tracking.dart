...
class _LocationTrackingState extends State<LocationTracking> {
  ...
  LatLng destinationLatlng = LatLng(41.017038, 28.847115);
  ...
  Widget build(BuildContext context) {
    CameraPosition initialCameraPosition = CameraPosition(
      ...
      // tilt: 80,
      bearing: 30,
      target: currentLocation != null ? LatLng(currentLocation!.latitude ?? 0.0, currentLocation!.longitude ?? 0.0) : LatLng(0.0, 0.0),
    );
