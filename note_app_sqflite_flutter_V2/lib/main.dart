...
import 'package:note_app_sqflite_flutterv2/bottomBar.dart';
import 'package:note_app_sqflite_flutterv2/kategori_islemleri.dart';
import 'package:note_app_sqflite_flutterv2/not_detay.dart';
...
import 'package:note_app_sqflite_flutterv2/utils/database_helper.dart';
...
class _NotListesiState extends State<NotListesi> {
  ...
  _kategorilerSayfasinaGit(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Kategoriler())).then((value) => setState(() {}));
  }
}
    ...
    return Column(
      children: [
        Container(
          ...
          decoration: BoxDecoration(color: greyColor, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(8), boxShadow: [
            BoxShadow(
