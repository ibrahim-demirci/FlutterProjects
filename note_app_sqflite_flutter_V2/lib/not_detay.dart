...
import 'package:note_app_sqflite_flutterv2/models/kategori_model.dart';
                      ...
                      ButtonBar(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: Colors.redAccent.shade200),
                            child: RaisedButton(
                              elevation: 0,
                              onPressed: () {
                                  ...
                                  if (widget.duzenlenecekNot == null) {
                                    ...
                                    databaseHelper
                                        .notGuncelle(Not.withID(
                                            widget.duzenlenecekNot.notID, kategoriID, notBaslik, notIcerik, suan.toString(), secilenOncelik))
                                        .then((guncellenenID) {
                                      if (guncellenenID != 0) {
                                        Navigator.pop(context);
                                      }
