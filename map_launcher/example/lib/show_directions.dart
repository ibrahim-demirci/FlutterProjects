...
class _ShowDirectionsState extends State<ShowDirections> {
  double destinationLatitude = 41.014909;
  double destinationLongitude = 28.844383;
  String destinationTitle = 'Ocean Beach';

  double originLatitude = 41.017864;
  double originLongitude = 28.847980;
  String originTitle = 'Pier 33';

  // List<Coords> waypoints = [];
  List<Coords> waypoints = [
    Coords(41.016454, 28.842682),
